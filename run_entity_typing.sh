...
# max len 256
python code/run_typing.py    --do_train   --do_lower_case   --data_dir $data   --ernie_model $model   --max_seq_length 256 --train_batch_size 16 --learning_rate 2e-5   --num_train_epochs 10.0   --output_dir $output --threshold 0.3 --loss_scale 128

# evaluate
# max len 256 
python code/eval_typing.py   --do_eval   --do_lower_case   --data_dir $data   --ernie_model $model   --max_seq_length 256   --train_batch_size 32   --learning_rate 2e-5   --num_train_epochs 10.0   --output_dir $output --threshold 0.3 --fp16 --loss_scale 128
