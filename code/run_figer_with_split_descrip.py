...
def main():
    ...
    def do_eval(mode="test", current_step=None):
      ...
      macro_score = loose_macro(true, pred)
      micro_score = loose_micro(true, pred)
      result = {
              'mode': mode,
      ...
      rr_result = [eval_accuracy, macro_score[-1], micro_score[-1]]
      rr.record(current_step, rr_result, mode)
