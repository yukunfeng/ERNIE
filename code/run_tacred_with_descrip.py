...
def convert_examples_to_features(examples, label_list, max_seq_length,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        tokens_a, entities_a = tokenizer.tokenize_with_descrip(ex_text_a, ent_pos, entity_id2parents, entity_id2label, max_parent)
        ...
        ents = [["UNK"]*max_parent] + entities_a + [["UNK"]*max_parent]
